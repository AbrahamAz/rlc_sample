...
strings <- c(
  dataset.name.short = "COUNTRY_ASSESSMENT_DATE",   # provide a short name for filenames of output documents (e.g. "POL_PDM")      # this string is only used for creating titles for output documents
